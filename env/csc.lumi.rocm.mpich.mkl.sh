...
if [ ! -d "dependencies/oneAPI-2025.0.0/install" ]
then
    echo "intel toolkit not installed in dependencies, please install it manually (MKL is enough)"
    return 1
fi
source dependencies/oneAPI-2025.0.0/install/setvars.sh
