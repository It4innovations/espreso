...
void test(int argc, char** argv) {
	...
	cout << "1 : " << omp_get_wtime() - start<< endl; 

	int partsCount = 4;
	int fixPointsCount = 8;
	
	cout << "2 : " << omp_get_wtime() - start<< endl; 

	Coordinates coords("matrices/HEX/15/coord");

	cout << "3 : " << omp_get_wtime() - start<< endl; 

	Mesh mesh("matrices/HEX/15/elem", coords, partsCount, fixPointsCount);

	cout << "4 : " << omp_get_wtime() - start<< endl; 

	Boundaries boundaries(mesh, coords);

	cout << "5 : " << omp_get_wtime() - start<< endl; 
	
	Faces faces(mesh, coords);

	cout << "6 : " << omp_get_wtime() - start<< endl; 
	
	Corners corners(faces.getFaces(), coords);

	cout << "7 : " << omp_get_wtime() - start<< endl; 
	...
	cout << "8 : " << omp_get_wtime() - start<< endl; 
	...
	cout << "9 : " << omp_get_wtime() - start<< endl; 
	...
	cout << "10: " << omp_get_wtime() - start<< endl; 
	...
	cout << "11: " << omp_get_wtime() - start<< endl; 
	...
	cout << "12: " << omp_get_wtime() - start<< endl; 
	...
	//	std::cout << "Part: " << part << ": ";
	//	for (int fixPoint = 0; fixPoint < fixPointsCount; fixPoint++) {
	//		std::cout << fixPoints[part * fixPointsCount + fixPoint] << " ";
	//	}
	//	std::cout << "\n";
	//} 
