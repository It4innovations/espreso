...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView2.ViewSize = [1146, 947]
      renderView2.AxesGrid = 'GridAxes3DActor'
      renderView2.CenterOfRotation = [116.55719156384879, -13.253037916672037, 10.94607604869723]
      renderView2.StereoType = 0
      renderView2.CameraPosition = [-15.055190650330246, -458.85855322773546, -29.716655367329622]
      renderView2.CameraFocalPoint = [116.55719156384879, -13.253037916672037, 10.94607604869723]
      renderView2.CameraViewUp = [0.0583155060966245, 0.07362552501068864, -0.9955795215931247]
      renderView2.CameraParallelScale = 120.7161415485484
      ...
      coprocessor.RegisterView(renderView2,
          filename='image_%t.png', freq=1, fittoscreen=0, magnification=1, width=1146, height=947, cinema={})
      ...
      warpByVector1.ScaleFactor = 10000000000.0
      ...
      displacementLUT.RGBPoints = [3.732278877493824e-16, 0.231373, 0.298039, 0.752941, 1.7162354395478114e-09, 0.865003, 0.865003, 0.865003, 3.432470505867735e-09, 0.705882, 0.0156863, 0.14902]
      ...
      displacementPWF.Points = [3.732278877493824e-16, 0.0, 0.5, 0.0, 3.432470505867735e-09, 1.0, 0.5, 0.0]
      ...
      warpByVector1Display.ScalarOpacityUnitDistance = 5.441368703659241
