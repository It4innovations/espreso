...
def CreateCoProcessor():
  def _CreatePipeline(coprocessor, datadescription):
    class Pipeline:
      ...
      renderView2.ViewSize = [1300, 1000]
      renderView2.AxesGrid = 'GridAxes3DActor'
      renderView2.CenterOfRotation = [0, 0, 0]
      renderView2.StereoType = 0
      renderView2.CameraPosition = [-30, -111, -10]
      renderView2.CameraFocalPoint = [15, 15, 15]
      renderView2.CameraViewUp = [0, 0, 0]
      renderView2.CameraParallelScale = 100
      ...
      warpByVector1.ScaleFactor = 1000.0
