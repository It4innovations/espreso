...
C
      RECURSIVE SUBROUTINE ZMUMPS_BACKSLV_RECV_AND_TREAT(
     &     BLOQ, FLAG,
     ...
     &          )
      ...
      END IF
      RETURN
      END SUBROUTINE ZMUMPS_BACKSLV_RECV_AND_TREAT
     ...
     &           ALPHA=(-1.0D0,0.0D0))
      ...
      EXTERNAL MUMPS_PROCNODE, ztrsv, ztrsm, zgemv, zgemm
 ...
 1010     CONTINUE
     ...
     &              W( P_UPDATE ), 1 )
          ELSE
#endif
           CALL zgemm( 'T', 'N', NPIV, NRHS_B, NROW_L, ALPHA, A(APOS),
     ...
     &              W( P_UPDATE ), 1 )
          ELSE
#endif
           CALL zgemm( 'N', 'N', NPIV, NRHS_B, NROW_L, ALPHA, A(APOS),
 ...
 100    CONTINUE
     ...
     &    (( NELIM .GT. 0 ).OR. (MTYPE.NE.1 )))  THEN
          ...
          IF (TWOBYTWO) THEN
            CALL ZMUMPS_BUILD_PANEL_POS(PANEL_SIZE, PANEL_POS,
 ...
 110            CALL ZMUMPS_BUF_SEND_VCB( NRHS_B, IN, 0, 0,
 ...
 270  CONTINUE
      ...
      CALL ZMUMPS_BDC_ERROR( MYID, SLAVEF, COMM )
      RETURN
      END SUBROUTINE ZMUMPS_BACKSLV_TRAITER_MESSAGE
      SUBROUTINE ZMUMPS_BUILD_PANEL_POS(PANEL_SIZE, PANEL_POS,
 ...
 10   CONTINUE
      ...
      RETURN
      END SUBROUTINE ZMUMPS_BUILD_PANEL_POS
