...
40      CONTINUE 
      ...
      SUBROUTINE ZMUMPS_SOL_X(A, NZ, N, IRN, ICN, Z, KEEP,KEEP8)
   ...
   10 CONTINUE
      ...
      SUBROUTINE ZMUMPS_SCAL_X(A, NZ, N, IRN, ICN, Z,
     &            KEEP, KEEP8, COLSCA)
   ...
   10 CONTINUE
      ...
      SUBROUTINE ZMUMPS_SOL_Y(A, NZ, N, IRN, ICN, RHS, X, R, W,
     &           KEEP,KEEP8)
      IMPLICIT NONE
      INTEGER,   intent(in)   :: NZ, N, KEEP(500)
      INTEGER(8), intent(in)   ::  KEEP8(150)
   ...
   10 CONTINUE
      ...
      SUBROUTINE ZMUMPS_SOL_B(N, KASE, X, EST, W, IW)
      INTEGER, intent(in)    :: N
  ...
  190 KASE = 0
      ...
      SUBROUTINE ZMUMPS_QD2( MTYPE, N, NZ, ASPK, IRN, ICN,
  ...
  100 CONTINUE
      CALL ZMUMPS_SOL_B(N, KASE, Y, COND(1), C_W, IW(1, 2))
  ...
  130 CONTINUE
      ...
      KASE = 0
  140 CONTINUE
      CALL ZMUMPS_SOL_B(N, KASE, Y, COND(2), C_W, IW(1, 2))
  ...
  170 CONTINUE
      ...
      SUBROUTINE ZMUMPS_SOL_Q(MTYPE, IFLAG, N, NZ,
