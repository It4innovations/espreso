...
namespace solver {
	...
	size_t   	PRECONDITIONER			= 1;		// 0 - NO preconditioner; 1 - Lumped; 2 - weight function; 3 - dirichlet
	...
	size_t		KSOLVER_SP_iter_steps   = 1;		// number of reiteration steps for SP direct solver
