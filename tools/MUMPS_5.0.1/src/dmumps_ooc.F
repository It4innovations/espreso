...
C
 ...
 500  CONTINUE
     ...
     &                    ERR_STR_OOC(1:DIM_ERR_STR_OOC)
      ...
      INTEGER IERR
      IERR=0
      IF(.NOT. id%IF_RESTARTING) CALL DMUMPS_OOC_CLEAN_FILES(id,IERR)
     ...
     &           SLAVEF_OOC).EQ.2).AND.(MUMPS_PROCNODE(
 ...
 666  CONTINUE
     ...
     &              KEEP_OOC(38), KEEP_OOC(20) )
      ...
      IF (IERR .GT. 0) THEN
         IF (ICNTL1.GT.0)
     &   WRITE(ICNTL1,*) 'PB allocation in DMUMPS_STRUC_STORE_FILE_NAME'
         IERR=-1
