...
function create_task {
    ...
    (
        ...
        echo "export ECF_UNIFORM_DECOMPOSITION=${uniform_decomposition}"
        ...
        echo "export ECF_FETI_METHOD=${feti_method}"
        echo "export ECF_DUAL_OPERATOR=${dualop}"
        echo "export ECF_PRECONDITIONER=${preconditioner}"
        echo "export ECF_PROJECTOR=${projector}"
        echo
...
array_preconditioners=(DIRICHLET_IMPLICIT DIRICHLET_GENERALSCHUR_CPU DIRICHLET_GENERALSCHUR_GPU)
array_approaches=(IMPLICIT_CPU EXPLICIT_CPU EXPLICIT_GPU)
            ...
            do
                ...
                do
                    ...
                    do
                        for k in 0 1 2
                        do
                            approach="${array_approaches[$k]}"
                            dualop="${array_dual_operators[$k]}"
                            preconditioner="${array_preconditioners[$k]}"
...
echo "    ./benchmarks/cluster_domain_size_2/submit_tasks.sh ${rundir}"
