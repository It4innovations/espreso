...
if not os.path.exists(basedir + "/graphs_speedup.py"):
    ...
    for problem in problems:
        ...
        for element_type_idx in range(len(element_types)):
            ...
            for niters in niters_list:
                ...
                axs[axs_y,axs_x].plot(ndofs_list, ys, color=color, linestyle=linestyle, linewidth=linewidth)
                axs[axs_y,axs_x].set_title(title, fontsize="medium")
                if ndofs == ndofs_list[-1]:
                    axs[axs_y,axs_x].text(ndofs_list[-1] * 1.1, ys[-1], str(niters) + " iters", fontsize="medium", verticalalignment="center", bbox=dict(edgecolor="none", facecolor="white", alpha=0.7, pad=0))
...
# min_niters = 10
# max_niters = 10000
# niters_list = [math.exp(x / 100 * (math.log(max_niters) - math.log(min_niters)) + math.log(min_niters)) for x in range(101)]
...
#                     axs[axs_y,axs_x].text(niters_list[-1] * 1.1, ys[-1], str(ndofs) + " DOFs", fontsize="medium", verticalalignment="center", bbox=dict(edgecolor="none", facecolor="white", alpha=0.7, pad=0))
