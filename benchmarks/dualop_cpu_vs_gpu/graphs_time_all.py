...
if not os.path.exists(basedir + "/graphs_time_all.py"):
...
for problem in problems:
    ...
    for element_type in element_types:
        ...
        for stage_idx in range(len(stages)):
            ...
            for approach_idx in range(len(approaches)):
                ...
                for mtd in mtds:
                    ...
                    if machine == "sprddr": linestyle = (0, (3, 1, 1, 1, 1, 1))
                    if machine == "sprhbm": linestyle = (0, (3, 1, 3, 1, 1, 1))
                    color = "black"
        ...
        fig.tight_layout()
        plt.savefig(outdir + "/" + problem + "-" + element_type + ".png")
        plt.close()
