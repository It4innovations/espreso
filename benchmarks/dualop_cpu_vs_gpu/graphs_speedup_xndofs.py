...
if not os.path.exists(basedir + "/graphs_speedup_xndofs.py"):
...
outdir = graphdir + "/speedup_xndofs"
    ...
    for problem in problems:
        ...
        for element_type_idx in range(len(element_types)):
            ...
            for niters in niters_list:
                ...
                tikzplotters[axs_y][axs_x].add_line(mytikzplot.line(ndofs_list, ys, color, linestyle, None, None))
