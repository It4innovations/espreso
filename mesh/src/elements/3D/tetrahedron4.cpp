...
std::vector<std::vector<double> > Tetra_N() {
  ...
  if (Tetrahedron4GPCount==4){
    vec_weight = {0.041666666666667,  0.041666666666667,  0.041666666666667,  0.041666666666667};
    ...
    wt = {-0.133333333333333, 0.075000000000000,  0.075000000000000,  0.075000000000000,  
          0.075000000000000};
    rv = {0.2500000000000000, 0.5000000000000000, 0.1666666666666667, 0.1666666666666667, 
          0.1666666666666667};
    sv = {0.2500000000000000, 0.1666666666666667, 0.1666666666666667, 0.1666666666666667, 
          0.5000000000000000};
    tv = {0.2500000000000000, 0.1666666666666667, 0.1666666666666667, 0.5000000000000000, 
          0.1666666666666667};
    ...
    vec_weight = {-0.013155555555556, 0.007622222222222, 0.007622222222222, 0.007622222222222,
                   0.007622222222222, 0.024888888888889, 0.024888888888889, 0.024888888888889,
                   0.024888888888889, 0.024888888888889, 0.024888888888889};
   
    
    rv = {0.2500000000000000, 0.7857142857142857, 0.0714285714285714, 0.0714285714285714, 
    ...
    sv = {0.2500000000000000, 0.0714285714285714, 0.0714285714285714, 0.0714285714285714, 
    ...
    tv = {0.2500000000000000, 0.0714285714285714, 0.0714285714285714, 0.7857142857142857, 
    ...
    vec_weight = {0.030283678097089, 0.006026785714286, 0.006026785714286, 0.006026785714286,
    ...
    rv = {0.2500000000000000, 0.0000000000000000, 0.3333333333333333, 0.3333333333333333, 
    ...
    sv = {0.2500000000000000, 0.3333333333333333, 0.3333333333333333, 0.3333333333333333, 
    ...
    tv = {0.2500000000000000, 0.3333333333333333, 0.3333333333333333, 0.0000000000000000, 
...
std::vector<double> Tetrahedron4::_weighFactor(Tetrahedron4NodesCount, vec_weight);
