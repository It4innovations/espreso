...
std::vector<std::vector<double> > Tetrahedron4::_dN = Tetra_dN();
std::vector<std::vector<double> > Tetrahedron4::_N = Tetra_N();
std::vector<double> Tetrahedron4::_weighFactor(Tetrahedron4NodesCount, 1.0 / 24.0);
