...
std::vector<DenseMatrix> Pyramid13_dN() {
	...
	for (unsigned int i = 0; i < Pyramid13GPCount; i++) {
		...
		m(0, 3) =  (t/2.0 - 0.5)*(t/8.0 - 1.0/8.0)*(r - 1.0)*(s + 1.0) - (t/8.0 - 1.0/8.0)*(s + 1.0)*(s*(t/2.0 - 0.5) - r*(t/2.0 - 0.5) + 1.0);
		m(0, 4) =  0.0;
...
std::vector<DenseMatrix> Pyramid13_N() {
