...
#ifndef SRC_PHYSICS_SYSTEM_BUILDER_HARMONICBUILDER_H_
#define SRC_PHYSICS_SYSTEM_BUILDER_HARMONICBUILDER_H_

#include "builder.h"

namespace espreso {

struct HarmonicBuilder: public Builder {
    HarmonicBuilder(int DOFs): DOFs(DOFs) {}
...
#endif /* SRC_PHYSICS_SYSTEM_BUILDER_HARMONICBUILDER_H_ */
