...
{
	const typename FETI<T>::Regularization *R = projector->feti->regularization;
...
static void _setG(OrthogonalTFETISymmetric<T> *projector)
{
	...
	const typename FETI<T>::Regularization *R = projector->feti->regularization;
	const typename FETI<T>::EqualityConstraints *L = projector->feti->equalityConstraints;
...
template <> OrthogonalTFETISymmetric<double>::OrthogonalTFETISymmetric(FETI<double> *feti): Projector(feti) { _set<double>(this); }
template <> OrthogonalTFETISymmetric<std::complex<double> >::OrthogonalTFETISymmetric(FETI<std::complex<double> > *feti): Projector(feti) { _set<std::complex<double> >(this); }
