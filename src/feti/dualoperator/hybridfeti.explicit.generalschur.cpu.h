...
#ifndef SRC_FETI_DUALOPERATOR_HYBRIDFETI_EXPLICIT_CPU_H_
#define SRC_FETI_DUALOPERATOR_HYBRIDFETI_EXPLICIT_CPU_H_
...
#endif /* SRC_FETI_DUALOPERATOR_HYBRIDFETI_EXPLICIT_CPU_H_ */
