...
protected:
    ...
    struct per_domain_stuff {
        ...
        gpu::spblas::buffer_info buffers_sptrsm1;
        gpu::spblas::buffer_info buffers_sptrsm2;
        gpu::spblas::buffer_info buffers_sptrsv1;
        gpu::spblas::buffer_info buffers_sptrsv2;
