...
#ifndef SRC_ANALYSIS_LINEARSYSTEM_MATRICES_MATRIX_DISTRIBUTED_SYNCHRONIZATION_H_
#define SRC_ANALYSIS_LINEARSYSTEM_MATRICES_MATRIX_DISTRIBUTED_SYNCHRONIZATION_H_
...
template <template<typename, typename, typename> typename Matrix, typename T> class Matrix_Distributed;

template <template<typename, typename, typename> typename Struct, typename T> struct Data_Synchronization { };
...
#endif /* SRC_ANALYSIS_LINEARSYSTEM_MATRICES_MATRIX_DISTRIBUTED_SYNCHRONIZATION_H_ */
