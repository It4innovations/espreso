...
template <size_t gps, size_t ndim, size_t etype, class Physics> struct HeatTransferCoordinateSystemSubKernel: HeatTransferCoordinateSystemKernel, Physics {
	HeatTransferCoordinateSystemSubKernel(const HeatTransferCoordinateSystemKernel &base): HeatTransferCoordinateSystemKernel(base) {}

	void simd(typename Physics::Element &element) {}
};

template <size_t gps, class Physics>
struct HeatTransferCoordinateSystemSubKernel<gps, 2, HeatTransferElementType::SYMMETRIC_GENERAL, Physics>: HeatTransferCoordinateSystemKernel, Physics {
	HeatTransferCoordinateSystemSubKernel(const HeatTransferCoordinateSystemKernel &base): HeatTransferCoordinateSystemKernel(base) {}
...
template <size_t gps, class Physics>
struct HeatTransferCoordinateSystemSubKernel<gps, 2, HeatTransferElementType::ASYMMETRIC_GENERAL, Physics>: HeatTransferCoordinateSystemKernel, Physics {
	HeatTransferCoordinateSystemSubKernel(const HeatTransferCoordinateSystemKernel &base): HeatTransferCoordinateSystemKernel(base) {}
...
template <size_t gps, class Physics>
struct HeatTransferCoordinateSystemSubKernel<gps, 3, HeatTransferElementType::SYMMETRIC_GENERAL, Physics>: HeatTransferCoordinateSystemKernel, Physics {
	HeatTransferCoordinateSystemSubKernel(const HeatTransferCoordinateSystemKernel &base): HeatTransferCoordinateSystemKernel(base) {}
...
template <size_t gps, class Physics>
struct HeatTransferCoordinateSystemSubKernel<gps, 3, HeatTransferElementType::ASYMMETRIC_GENERAL, Physics>: HeatTransferCoordinateSystemKernel, Physics {
	HeatTransferCoordinateSystemSubKernel(const HeatTransferCoordinateSystemKernel &base): HeatTransferCoordinateSystemKernel(base) {}
