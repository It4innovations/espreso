...
struct TemperatureSubKernelToElementNodes: TemperatureKernel, Physics {
	TemperatureSubKernelToElementNodes(const TemperatureKernel &base): TemperatureKernel(base) {}
