...
template <>
void HeatTransfer::runElement<Element::CODE::TRIANGLE3>(const step::Step &step, SubKernel::Action action, size_t interval)
{
    switch (action) {
    ...
    case SubKernel::Action::SOLUTION:
        runElementKernel<Element::CODE::TRIANGLE3, 3, HeatTransferGPC::TRIANGLE3, 2, 2>(step, subkernels[interval], action); break;
    default: break;
    }
}

template <>
void HeatTransfer::runBoundary<Element::CODE::TRIANGLE3>(const step::Step &step, SubKernel::Action action, size_t region, size_t interval)
{
    switch (action) {
    case SubKernel::Action::PREPROCESS:
