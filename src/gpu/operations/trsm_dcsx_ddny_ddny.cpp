...
std::unique_ptr<trsm_dcsx_ddny_ddny<T,I>> trsm_dcsx_ddny_ddny<T,I>::make()
{
    // feel free to make this runtime ifs based on ecf or env
        ...
        return std::make_unique<w_onesparse_trsm_dcsx_ddny_ddny<T,I>>();
    #endif
...
{
    stacktimer::push("trsm_dcsx_ddny_ddny::setup");
...
{
    stacktimer::push("trsm_dcsx_ddny_ddny::preprocess_submit");
...
{
    stacktimer::push("trsm_dcsx_ddny_ddny::perform_submit");
