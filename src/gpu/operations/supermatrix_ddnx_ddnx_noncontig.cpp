...
std::unique_ptr<supermatrix_ddnx_ddnx_noncontig<T,I>> supermatrix_ddnx_ddnx_noncontig<T,I>::make()
{
        ...
        return std::make_unique<w_rocm_supermatrix_ddnx_ddnx_noncontig<T,I>>();
    #endif
    #ifdef ESPRESO_USE_WRAPPER_GPU_ONEAPI
        return std::make_unique<w_oneapi_supermatrix_ddnx_ddnx_noncontig<T,I>>();
    #endif
...
template<typename T, typename I>
void supermatrix_ddnx_ddnx_noncontig<T,I>::set_handles(gpu::mgm::queue q_)
{
...
template<typename T, typename I>
void supermatrix_ddnx_ddnx_noncontig<T,I>::set_matrix_src(MatrixDenseView_new<T> * d_M_src_)
{
...
template<typename T, typename I>
void supermatrix_ddnx_ddnx_noncontig<T,I>::set_matrix_dst(MatrixDenseView_new<T> * d_M_dst_)
{
...
template<typename T, typename I>
void supermatrix_ddnx_ddnx_noncontig<T,I>::set_row_map(VectorDenseView_new<I> * d_row_map_)
{
...
template<typename T, typename I>
void supermatrix_ddnx_ddnx_noncontig<T,I>::set_col_map(VectorDenseView_new<I> * d_col_map_)
{
...
template class supermatrix_ddnx_ddnx_noncontig<T,I>;
