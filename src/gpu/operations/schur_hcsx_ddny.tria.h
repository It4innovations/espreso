...
template<typename T, typename I>
class schur_hcsx_ddny_tria : public schur_hcsx_ddny<T,I>
{
public:
    schur_hcsx_ddny_tria();
    schur_hcsx_ddny_tria(const schur_hcsx_ddny_tria &) = delete;
    schur_hcsx_ddny_tria(schur_hcsx_ddny_tria &&) = default;
    schur_hcsx_ddny_tria & operator=(const schur_hcsx_ddny_tria &) = delete;
