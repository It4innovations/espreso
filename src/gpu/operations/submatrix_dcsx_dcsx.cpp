...
std::unique_ptr<submatrix_dcsx_dcsx<T,I>> submatrix_dcsx_dcsx<T,I>::make()
{
    // feel free to make this runtime ifs based on ecf or env
        ...
        return std::make_unique<w_oneapi_submatrix_dcsx_dcsx<T,I>>();
    #endif
...
template<typename T, typename I>
void submatrix_dcsx_dcsx<T,I>::set_handles(gpu::mgm::queue q_)
{
...
template<typename T, typename I>
void submatrix_dcsx_dcsx<T,I>::set_bounds(size_t row_start_, size_t row_end_, size_t col_start_, size_t col_end_)
{
...
template<typename T, typename I>
void submatrix_dcsx_dcsx<T,I>::set_matrix_src(MatrixCsxView_new<T,I> * M_src_)
{
...
template<typename T, typename I>
void submatrix_dcsx_dcsx<T,I>::set_matrix_dst(MatrixCsxView_new<T,I> * M_dst_)
{
...
template<typename T, typename I>
size_t submatrix_dcsx_dcsx<T,I>::get_wss_internal()
{
...
template<typename T, typename I>
size_t submatrix_dcsx_dcsx<T,I>::get_wss_persistent()
{
    if(!called_setup) eslog::error("setup was not called\n");
...
template<typename T, typename I>
size_t submatrix_dcsx_dcsx<T,I>::get_wss_tmp_preprocess()
{
    if(!called_setup) eslog::error("setup was not called\n");
...
template<typename T, typename I>
size_t submatrix_dcsx_dcsx<T,I>::get_wss_tmp_perform()
{
    if(!called_setup) eslog::error("setup was not called\n");
...
template<typename T, typename I>
void submatrix_dcsx_dcsx<T,I>::set_ws_persistent(void * ws_persistent_)
{
...
template class submatrix_dcsx_dcsx<T,I>;
