...
template <typename T>
static void _addSFCNeighbors(const SpaceFillingCurve<T> *sfc, size_t depth, size_t index, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors)
{
...
template <typename T>
static void _addXYNeighbors(const SpaceFillingCurve<T> *sfc, size_t depth, size_t x, size_t y, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors)
{
...
template <typename T>
static void _addXYZNeighbors(const SpaceFillingCurve<T> *sfc, size_t depth, size_t x, size_t y, size_t z, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors)
{
	std::vector<std::pair<size_t, size_t> > potential;
...
template <> void SpaceFillingCurve<float>::addSFCNeighbors(size_t depth, size_t index, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors) const { _addSFCNeighbors(this, depth, index, splitters, neighbors); }
template <> void SpaceFillingCurve<double>::addSFCNeighbors(size_t depth, size_t index, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors) const { _addSFCNeighbors(this, depth, index, splitters, neighbors); }

template <> void SpaceFillingCurve<float>::addXYNeighbors(size_t depth, size_t x, size_t y, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors) const { _addXYNeighbors(this, depth, x, y, splitters, neighbors); }
template <> void SpaceFillingCurve<double>::addXYNeighbors(size_t depth, size_t x, size_t y, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors) const { _addXYNeighbors(this, depth, x, y, splitters, neighbors); }

template <> void SpaceFillingCurve<float>::addXYZNeighbors(size_t depth, size_t x, size_t y, size_t z, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors) const { _addXYZNeighbors(this, depth, x, y, z, splitters, neighbors); }
template <> void SpaceFillingCurve<double>::addXYZNeighbors(size_t depth, size_t x, size_t y, size_t z, const ivector<esint> &splitters, std::vector<std::pair<size_t, size_t> > &neighbors) const { _addXYZNeighbors(this, depth, x, y, z, splitters, neighbors); }
