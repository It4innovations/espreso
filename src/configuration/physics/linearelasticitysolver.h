...
#ifndef SRC_CONFIGURATION_PHYSICS_LINEARELASTICITYSOLVER_H_
#define SRC_CONFIGURATION_PHYSICS_LINEARELASTICITYSOLVER_H_
...
struct LinearElasticityNonLinearConvergence: public NonLinearConvergence {
...
struct LinearElasticitySolver: public Configuration {
	...
	SUBMAPTOCONFIG(size_t, NonLinearSolver<LinearElasticityNonLinearConvergence>, nonlinear_solver, "Non-linear configuration for each load step.", "1", "Description of non-linear solver for step '1'");
...
#endif /* SRC_CONFIGURATION_PHYSICS_LINEARELASTICITYSOLVER_H_ */
