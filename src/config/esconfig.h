...
namespace solver {
    ...
    /// Load balancing between host and Intel Xeon Phi (system matrix)
    extern bool LOAD_BALANCING;
    
    /// Load balancing between host and Intel Xeon Phi (preconditioner)
    extern bool LOAD_BALANCING_PREC;
