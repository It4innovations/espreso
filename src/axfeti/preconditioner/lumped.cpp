...
template <> Lumped<double>::Lumped(AX_FETI<double> *feti): Preconditioner(feti) { _set<double>(this); }
template <> Lumped<std::complex<double> >::Lumped(AX_FETI<std::complex<double> > *feti): Preconditioner(feti) { _set<std::complex<double> >(this); }
