...
#ifndef SRC_PHYSICS_ASSEMBLER_KERNELS_KERNEL_PARAMETERS_H_
#define SRC_PHYSICS_ASSEMBLER_KERNELS_KERNEL_PARAMETERS_H_
...
#endif /* SRC_PHYSICS_ASSEMBLER_KERNELS_KERNEL_PARAMETERS_H_ */
