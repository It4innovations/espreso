...
#ifndef SRC_WRAPPERS_ONEAPI_OPERATIONS_W_ONEAPI_SUBMATRIX_DCSX_DCSX_H
#define SRC_WRAPPERS_ONEAPI_OPERATIONS_W_ONEAPI_SUBMATRIX_DCSX_DCSX_H
...
class w_oneapi_submatrix_dcsx_dcsx : public submatrix_dcsx_dcsx<T,I>
{
public:
    w_oneapi_submatrix_dcsx_dcsx() = default;
    virtual ~w_oneapi_submatrix_dcsx_dcsx() = default;
protected:
...
{
public:
    w_oneapi_submatrix_dcsx_dcsx() { eslog::error("oneapi wrapper is not available\n"); }
    virtual ~w_oneapi_submatrix_dcsx_dcsx() = default;
};
...
#endif /* SRC_WRAPPERS_ONEAPI_OPERATIONS_W_ONEAPI_SUBMATRIX_DCSX_DCSX_H */
