...
template<typename T, typename I, typename OP>
static void do_supermatrix_launch_kernel_2(cudaStream_t stream, size_t size_src_primary, size_t size_src_secdary, T * src, size_t ld_src, T * dst, size_t ld_dst, I * map_primary, I * map_secdary, OP op)
{
    dim3 tpb(32,8);
    dim3 n(2,2);
...
static void do_supermatrix_launch_kernel_1(cudaStream_t stream, size_t size_src_primary, size_t size_src_secdary, T * src, size_t ld_src, T * dst, size_t ld_dst, I * map_primary, I * map_secdary, typename supermatrix_ddnx_ddnx_noncontig<T,I>::mode mode_val)
{
