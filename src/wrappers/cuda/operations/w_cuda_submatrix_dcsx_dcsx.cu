...
template<typename T, typename I>
void w_cuda_submatrix_dcsx_dcsx<T,I>::internal_setup()
{
...
template<typename T, typename I>
void w_cuda_submatrix_dcsx_dcsx<T,I>::internal_preprocess(void * ws_tmp)
{
    size_t dst_size_primary = M_dst->get_size_primary();
...
template<typename T, typename I>
void w_cuda_submatrix_dcsx_dcsx<T,I>::internal_perform(void * /*ws_tmp*/)
{
    size_t dst_size_primary = M_dst->get_size_primary();
...
template class w_cuda_submatrix_dcsx_dcsx<T,I>;
