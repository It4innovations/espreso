...
#ifndef SRC_WRAPPERS_SUITESPARSE_OPERATIONS_SOLVER_CSX_UMFPACK_H
#define SRC_WRAPPERS_SUITESPARSE_OPERATIONS_SOLVER_CSX_UMFPACK_H
...
// struct solver_csx_umfpack_data;

// template<typename T, typename I>
// class solver_csx_umfpack : public solver_csx<T,I>
// {
// public:
//     solver_csx_umfpack();
//     solver_csx_umfpack(const solver_csx_umfpack &) = delete;
//     solver_csx_umfpack(solver_csx_umfpack &&) = default;
...
// public:
//     const char * get_name() override { return "solver_csx_umfpack"; }
// protected:
...
// private:
//     std::unique_ptr<solver_csx_umfpack_data<T,I>> data;
// protected:
...
{
public:
    solver_csx_umfpack() { eslog::error("suitesparse/umfpack wrapper is not available\n"); }
    virtual ~solver_csx_umfpack() = default;
};
...
#endif /* SRC_WRAPPERS_SUITESPARSE_OPERATIONS_SOLVER_CSX_UMFPACK_H */
