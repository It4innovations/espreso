...
template<typename T, typename I>
class sc_csx_dny_mklpardiso : public sc_csx_dny<T,I>
{
public:
    sc_csx_dny_mklpardiso();
    sc_csx_dny_mklpardiso(const sc_csx_dny_mklpardiso &) = delete;
    sc_csx_dny_mklpardiso(sc_csx_dny_mklpardiso &&) = default;
    sc_csx_dny_mklpardiso & operator=(const sc_csx_dny_mklpardiso &) = delete;
    sc_csx_dny_mklpardiso & operator=(sc_csx_dny_mklpardiso &&) = default;
    virtual ~sc_csx_dny_mklpardiso();
protected:
...
private:
    std::unique_ptr<sc_csx_dny_mklpardiso_data<T,I>> data;
protected:
...
{
public:
    sc_csx_dny_mklpardiso() { eslog::error("operation sc_csx_dny_mklpardiso is not available\n"); }
    virtual ~sc_csx_dny_mklpardiso() = default;
};
