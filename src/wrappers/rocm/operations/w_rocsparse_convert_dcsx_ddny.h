...
#ifndef SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCSPARSE_CONVERT_DCSX_DDNY_H
#define SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCSPARSE_CONVERT_DCSX_DDNY_H
...
class w_rocsparse_convert_dcsx_ddny : public convert_dcsx_ddny<T,I>
{
public:
    w_rocsparse_convert_dcsx_ddny();
    virtual ~w_rocsparse_convert_dcsx_ddny();
protected:
...
private:
    std::unique_ptr<w_rocsparse_convert_dcsx_ddny_data> data;
};
...
{
public:
    w_rocsparse_convert_dcsx_ddny() { eslog::error("rocm wrapper is not available\n"); }
    virtual ~w_rocsparse_convert_dcsx_ddny() = default;
};
...
#endif /* SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCSPARSE_CONVERT_DCSX_DDNY_H */
