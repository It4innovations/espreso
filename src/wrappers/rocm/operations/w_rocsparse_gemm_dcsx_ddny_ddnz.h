...
#ifndef SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCSPARSE_GEMM_DCSX_DDNY_DDNZ_H
#define SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCSPARSE_GEMM_DCSX_DDNY_DDNZ_H
...
template<typename T, typename I>
class w_rocsparse_gemm_dcsx_ddny_ddnz : public gemm_dcsx_ddny_ddnz<T,I>
{
public:
    w_rocsparse_gemm_dcsx_ddny_ddnz();
    virtual ~w_rocsparse_gemm_dcsx_ddny_ddnz();
protected:
...
private:
    std::unique_ptr<w_rocsparse_gemm_dcsx_ddny_ddnz_data<T,I>> data;
};
...
{
public:
    w_rocsparse_gemm_dcsx_ddny_ddnz() { eslog::error("rocm wrapper is not available\n"); }
    virtual ~w_rocsparse_gemm_dcsx_ddny_ddnz() = default;
};
...
#endif /* SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCSPARSE_GEMM_DCSX_DDNY_DDNZ_H */
