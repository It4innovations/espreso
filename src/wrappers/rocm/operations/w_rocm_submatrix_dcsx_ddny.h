...
#ifndef SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCM_SUBMATRIX_DCSX_DDNY_H
#define SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCM_SUBMATRIX_DCSX_DDNY_H
...
class w_rocm_submatrix_dcsx_ddny : public submatrix_dcsx_ddny<T,I>
{
public:
    w_rocm_submatrix_dcsx_ddny() = default;
    virtual ~w_rocm_submatrix_dcsx_ddny() = default;
protected:
...
{
public:
    w_rocm_submatrix_dcsx_ddny() { eslog::error("rocm wrapper is not available\n"); }
    virtual ~w_rocm_submatrix_dcsx_ddny() = default;
};
...
#endif /* SRC_WRAPPERS_ROCM_OPERATIONS_W_ROCM_SUBMATRIX_DCSX_DDNY_H */
