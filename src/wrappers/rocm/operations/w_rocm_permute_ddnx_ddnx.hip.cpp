...
void w_rocm_permute_ddnx_ddnx<T,I>::internal_setup()
{
    wss_tmp_perform = 0;
}
...
template<typename T, typename I>
void w_rocm_permute_ddnx_ddnx<T,I>::internal_perform(void * ws_tmp)
{
...
template class w_rocm_permute_ddnx_ddnx<T,I>;
