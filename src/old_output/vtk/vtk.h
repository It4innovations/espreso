...
#ifndef SRC_OLD_OUTPUT_VTK_VTK_H_
#define SRC_OLD_OUTPUT_VTK_VTK_H_
...
public:
	...
	static void gluing(const OutputConfiguration &output, const Mesh &mesh, const Instance &instance, const std::string &path, size_t dofs);
...
#endif /* SRC_OLD_OUTPUT_VTK_VTK_H_ */
