...
#ifndef SRC_OLD_OUTPUT_RESULTSTORELIST_H_
#define SRC_OLD_OUTPUT_RESULTSTORELIST_H_

#include "../old_output/resultstore.h"
...
#endif /* SRC_OLD_OUTPUT_RESULTSTORELIST_H_ */
