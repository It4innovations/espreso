...
#include "../../../old_physics/linear/stokes/assembler.h"
...
void Stokes::saveMeshProperties(output::ResultStore &store)
{

}

void Stokes::saveMeshResults(output::ResultStore &store, const std::vector<std::vector<double> > &results)
{
