...
#ifndef SRC_ASSEMBLER_OLD_PHYSICS_LINEAR_STOKES_ASSEMBLER_H_
#define SRC_ASSEMBLER_OLD_PHYSICS_LINEAR_STOKES_ASSEMBLER_H_
...
#endif /* SRC_ASSEMBLER_OLD_PHYSICS_LINEAR_STOKES_ASSEMBLER_H_ */
