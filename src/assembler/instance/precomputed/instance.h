...
struct PrecomputedInstance: public Instance
{
	...
	: Instance(mesh), _physics(mesh, rhs, rhs_size), _constrains(mesh, _physics.pointDOFs, dirichlet_size, dirichlet_indices, dirichlet_values, indexBase), _linearSolver(_physics, _constrains)
	{
