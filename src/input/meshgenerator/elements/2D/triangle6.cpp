...
void Triangle6::addEdges(std::vector<Element*> &edges, const eslocal indices[], CubeEdges edge)
{
	eslocal line[3];
	switch (edge) {
...
void Triangle6::pickNodes(const std::vector<Element*> &nodes, std::vector<Element*> &selection, const eslocal indices[], CubeEdges edge)
{
	switch (edge) {
	case CubeEdges::X_0_Z_0:
