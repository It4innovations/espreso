...
void submatrix_csx_csy_map<T,I>::set_matrix_src(MatrixCsxView_new * M_src_)
{
    M_src = M_src_;
}
...
template<typename T, typename I>
void submatrix_csx_csy_map<T,I>::get_output_matrix_nnz()
{
...
template<typename T, typename I>
void submatrix_csx_csy_map<T,I>::set_matrix_dst(MatrixCsxView_new * M_dst_)
{
    M_dst = M_dst_;
}
...
template<typename T, typename I>
void submatrix_csx_csy_map<T,I>::do_all(MatrixCsxView_new<T,I> * M_src, MatrixDenseView_new<T> * M_dst, size_t row_start, size_t row_end, size_t col_start, size_t col_end)
{
...
template<typename T, typename I>
void submatrix_csx_csy_map<T,I>::perform_diff_order()
{
