...
{
    stacktimer::push("schur_csx_dny::solve_A11 (vector)");
...
template<typename T, typename I>
void schur_csx_dny<T,I>::solve_A11(MatrixDenseView_new<T> & rhs, MatrixDenseView_new<T> & sol)
{
    stacktimer::push("schur_csx_dny::solve_A11 (matrix)");
