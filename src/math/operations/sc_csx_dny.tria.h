...
template<typename T, typename I>
class sc_csx_dny_tria : public sc_csx_dny<T,I>
{
public:
    sc_csx_dny_tria();
    sc_csx_dny_tria(const sc_csx_dny_tria &) = delete;
    sc_csx_dny_tria(sc_csx_dny_tria &&) = default;
    sc_csx_dny_tria & operator=(const sc_csx_dny_tria &) = delete;
    sc_csx_dny_tria & operator=(sc_csx_dny_tria &&) = default;
    virtual ~sc_csx_dny_tria();
protected:
...
private:
    std::unique_ptr<sc_csx_dny_tria_data<T,I>> data;
protected:
