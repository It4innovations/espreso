...
#ifndef SRC_MATH_OPERATIONS_SUBMATIX_DNX_DNX_NONCONTIG_H
#define SRC_MATH_OPERATIONS_SUBMATIX_DNX_DNX_NONCONTIG_H
...
#endif /* SRC_MATH_OPERATIONS_SUBMATIX_DNX_DNX_NONCONTIG_H */
