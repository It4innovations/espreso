...
Domain::Domain(const ESPRESOSolver &configuration): configuration(configuration)
{

}

Domain::Domain(const ESPRESOSolver &configuration, eslocal domain_index, eslocal use_dynamic_1_no_dynamic_0): configuration(configuration)
{
