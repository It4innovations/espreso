...
class Solver(unittest.TestCase):
    ...
    def setUp(self):
        ...
        ESPRESOTest.args = [ "TETRA4", 2, 2, 1, 2, 2, 2, 4, 4, 8, "TOTAL_FETI", "ORTHOGONAL", "DEFAULT", 23 ]
    ...
    def test_feti(self):
        for opt in [ "          DEFAULT", "     WITH_FACTORS", "             FULL", "WITH_FACTORS|FULL" ]:
            yield run, " TOTAL_FETI", "ORTHOGONAL", opt, 23
        for opt in [ "          DEFAULT", "     WITH_FACTORS"]:
            yield run, "HYBRID_FETI", "ORTHOGONAL", opt, 25
