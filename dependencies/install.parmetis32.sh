...
export LIBRARY_PATH="${PARMETIS_ROOT}/$1_32/lib:${PARMETIS_ROOT}/$1_32/lib64:${LIBRARY_PATH}"
export LD_LIBRARY_PATH="${PARMETIS_ROOT}/$1_32/lib:${PARMETIS_ROOT}/$1_32/lib64:${LD_LIBRARY_PATH}"
echo "          CPATH+=${PARMETIS_ROOT}/$1_32/include"
echo "   LIBRARY_PATH+=${PARMETIS_ROOT}/$1_32/lib"
echo "LD_LIBRARY_PATH+=${PARMETIS_ROOT}/$1_32/lib"
