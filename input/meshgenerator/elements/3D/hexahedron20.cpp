...
Hexahedron20::Hexahedron20(const esinput::CubeSettings &settings): _settings(settings)
{
	eslocal nodes[3];
...
eslocal Hexahedron20::clusterNodesCount(const esinput::CubeSettings &settings)
{
	eslocal nodes[3];
...
esglobal Hexahedron20::globalNodesCount(const esinput::CubeSettings &settings)
{
	esglobal nodes[3];
