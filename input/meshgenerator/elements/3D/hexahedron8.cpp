...
Hexahedron8::Hexahedron8(const esinput::CubeSettings &settings): _settings(settings)
{
...
eslocal Hexahedron8::clusterNodesCount(const esinput::CubeSettings &settings)
{
	eslocal nodes[3];
...
esglobal Hexahedron8::globalNodesCount(const esinput::CubeSettings &settings)
{
	esglobal nodes[3];
