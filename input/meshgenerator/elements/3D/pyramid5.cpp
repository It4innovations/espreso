...
#include "../../../meshgenerator/elements/3D/pyramid5.h"
...
Pyramid5::Pyramid5(const esinput::CubeSettings &settings): _settings(settings)
{
	eslocal nodes[3];
...
eslocal Pyramid5::clusterNodesCount(const esinput::CubeSettings &settings)
{
...
esglobal Pyramid5::globalNodesCount(const esinput::CubeSettings &settings)
{
