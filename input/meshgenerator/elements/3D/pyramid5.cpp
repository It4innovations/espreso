...
void Pyramid5::addElements(std::vector<mesh::Element*> &elements, const eslocal indices[], const eslocal params[])
{
	eslocal pyramid[5];
	...
	elements.push_back(new mesh::Pyramid5(pyramid, 5, params));
