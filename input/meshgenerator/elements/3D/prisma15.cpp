...
#include "../../../meshgenerator/elements/3D/prisma15.h"
...
Prisma15::Prisma15(const esinput::CubeSettings &settings): _settings(settings)
{
	eslocal nodes[3];
...
eslocal Prisma15::clusterNodesCount(const esinput::CubeSettings &settings)
{
	eslocal nodes[3];
...
esglobal Prisma15::globalNodesCount(const esinput::CubeSettings &settings)
{
	esglobal nodes[3];
