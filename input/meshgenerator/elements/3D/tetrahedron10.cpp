...
#include "../../../meshgenerator/elements/3D/tetrahedron10.h"
...
Tetrahedron10::Tetrahedron10(const esinput::CubeSettings &settings): _settings(settings)
{
...
eslocal Tetrahedron10::clusterNodesCount(const esinput::CubeSettings &settings)
{
	eslocal nodes[3];
...
esglobal Tetrahedron10::globalNodesCount(const esinput::CubeSettings &settings)
{
	esglobal nodes[3];
